...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/chiibitsu/aikiri-vault-kit&root-directory=vault-mcp&project-name=my-second-brain&repository-name=my-second-brain&env=VAULT_GITHUB_TOKEN,VAULT_MCP_TOKEN,OAUTH_SIGNING_SECRET,VAULT_OWNER_PASSPHRASE,VAULT_OWNER,VAULT_REPO)
