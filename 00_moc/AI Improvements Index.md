...
- [[2026-08-11-class-not-instances-and-cross-session-audit]] — a cross-session audit dismissed on principle before checking what was at the other end, and the finding it produced: the write guard enumerated one vendor's instruction filenames instead of the class its own refusal message names, leaving seven agent instruction and tool-configuration files writable; plus the first recorded restore drill (2026-08-11)
